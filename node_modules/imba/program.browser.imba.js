var F=Symbol.for("#__init__"),hr=Symbol.for("#__initor__"),an=Symbol.for("#__inited__"),ur=Symbol.for("#__hooks__");var ln=Symbol.for("#meta"),Oe=Symbol.for("imba");var ps={SUPERCALLS:1<<3,CONSTRUCTOR:1<<4},ge={IsExtension:1<<0,IsTag:1<<1,HasDescriptors:1<<2,HasSuperCalls:1<<3,HasConstructor:1<<4,HasFields:1<<5,HasMixins:1<<6,HasInitor:1<<7,HasDecorators:1<<8,IsObjectExtension:1<<9},re=new Map,cn=globalThis[Oe]||(globalThis[Oe]={counter:0,classes:re});function pe(s,e={}){var t;return re.has(s)||re.set(s,{symbol:Symbol(),parent:(t=Object.getPrototypeOf(s.prototype))==null?void 0:t.constructor,for:s,uses:[],inits:[],id:cn.counter++,...e}),re.get(s)}function R(s,e){var t;return typeof e=="string"?typeof s===e:(t=e==null?void 0:e[Symbol.hasInstance])==null?void 0:t.call(e,s)}function I(s){var e;return((e=s==null?void 0:s.toIterable)==null?void 0:e.call(s))||s}function pn(s,e){if(!s||!e)return!1;if(s.get)return e.get===s.get;if(s.set)return e.set===s.set;if(s.value)return s.value===e.value}function mr(s,e,t){let r=s.constructor;t!=null||(t=Object.getOwnPropertyDescriptors(e));let n=Object.getOwnPropertyDescriptors(s);delete t.constructor,t[F]&&delete t[F],Object.defineProperties(s,t);let i=pe(r);if(i&&i.augments)for(let a of i.augments){let o=Object.getOwnPropertyDescriptors(a.prototype),f={};for(let c of Object.keys(t)){let l=t[c];o[c]&&!pn(n[c],o[c])?console.warn("wont extend",c):f[c]=l}Object.keys(f).length&&mr(a.prototype,null,f)}return s}function dr(s,e){let t=pe(s),r=pe(e);if(r.parent&&!(s.prototype instanceof r.parent))throw new Error(`Mixin ${e.name} has superclass not present in target class`);if(!r.augments){r.augments=new Set;let i=r.ref=Symbol(),a=Object[Symbol.hasInstance];e.prototype[i]=!0,Object.defineProperty(e,Symbol.hasInstance,{value:function(o){return this===e?o&&!!o[i]:a.call(this,o)}})}if(s.prototype[r.ref])return s;for(let i of r.uses)dr(s,i,t);r.augments.add(s),t.uses.push(e);let n=Object.getOwnPropertyDescriptors(e.prototype);delete n.constructor,n[F]&&(t.inits.push(e.prototype[F]),delete n[F]),Object.defineProperties(s.prototype,n);try{t.top.version++}catch{}return s}var X={cache:{},self:null,target:null,proxy:new Proxy({},{apply:(s,e,...t)=>X.target[e].apply(X.self,t),get:(s,e)=>Reflect.get(X.target,e,X.self),set:(s,e,t,r)=>Reflect.set(X.target,e,t,X.self)})};function $(s,e,t,r,n=null){var c,l;let i=Object.getPrototypeOf(s.prototype);if(r&ge.HasMixins&&(re.set(s,re.get(i.constructor)),i=Object.getPrototypeOf(i)),n){let p=r&ge.IsObjectExtension?n:n.prototype,u=pe(s);if((c=u.uses)!=null&&c.length){n===p&&console.warn("Cannot extend object with mixins");for(let h of u.uses)dr(n,h)}return r&ge.HasSuperCalls&&(X.cache[e]=Object.create(Object.getPrototypeOf(p),Object.getOwnPropertyDescriptors(p))),mr(p,s.prototype),n}let o=i==null?void 0:i.constructor,f=pe(s,{symbol:e});if(Object.defineProperty(s,ln,{value:f,enumerable:!1,configurable:!0}),t&&s.name!==t&&Object.defineProperty(s,"name",{value:t,configurable:!0}),f.flags=r,r&ge.HasConstructor&&(s.prototype[hr]=e),f.uses)for(let p of f.uses)(l=p.mixes)==null||l.call(p,s);return(o==null?void 0:o.inherited)instanceof Function&&o.inherited(s),s}function N(s,e){var t;s[hr]===e&&((t=s[an])==null||t.call(s),s[ur]&&s[ur].inited(s))}var ne=Symbol.for("#source"),fn=Symbol.for("#lineText"),un=Symbol.for("#version"),gr=new WeakMap,yr=Symbol(),Ae=class{[F](e=null,t=!0,r=!0){this.line=e?e.line:void 0,this.character=e?e.character:void 0,this.offset=e?e.offset:void 0}constructor(e,t,r,n=null){this[F](),this.line=e,this.character=t,this.offset=r,this[un]=n,N(this,yr)}toString(){return""+this.line+":"+this.character}valueOf(){return this.offset}},Q=Ae;(()=>{$(Ae,yr,"Position",16)})();var _r=Symbol(),Ee=class{[F](e=null,t=!0,r=!0){this.start=e?e.start:void 0,this.end=e?e.end:void 0}constructor(e,t){this[F](),this.start=e,this.end=t,N(this,_r)}get offset(){return this.start.offset}get length(){return this.end.offset-this.start.offset}get 0(){return this.start.offset}get 1(){return this.end.offset}getText(e){return e.slice(this.start,this.end)}equals(e){return e.offset==this.offset&&e.length==this.length}},H=Ee;(()=>{$(Ee,_r,"Range",16)})();var hn={Error:1,Warning:2,Information:3,Hint:4,error:1,warning:2,warn:2,info:3,hint:4},br=Symbol(),Me=class{constructor(e,t=null){this.range=e.range,this.severity=hn[e.severity]||e.severity,this.code=e.code,this.source=e.source,this.message=e.message,gr.set(this,t),N(this,br)}get[ne](){return gr.get(this)}get[fn](){return this[ne].doc.getLineText(this.range.start.line)}toSnippet(){let e=this.range.start,t=this.range.end,r=""+this[ne].sourcePath+":"+(e.line+1)+":"+(e.character+1)+": "+this.message,n=this[ne].doc.getLineText(e.line),i=[r,n];return i.push(n.replace(/[^\t]/g," ").slice(0,e.character)+"^".repeat(t.character-e.character)),i.join(`
`).replace(/\t/g,"    ")+`
